...
def test_actorDict_read():
    ...
    actorDict1 = {'#': [('YUGHRV', ['<910625']), ('HRVUNR', ['911008', '920115']), ('HRV', ['>920115']), ('HRV', [])]}
    ...
    actorDict2 = {'ELLEMANN': {'JENSEN': {'#': [('IGOEUREEC', ['820701', '821231']), ('IGOEUREEC', ['870701', '871231'])]}}}
    ...
    #[EGYGOV > 140608]
    #[EGYELI]
    actorDict3 = {'#': [('EGYMIL', ['770101', '120812']), ('EGYGOVMIL', ['120812', '140326']), ('EGYGOV', ['>140608']), ('EGYELI', [])]}

    #actorDict4-6 are examples that phrase and code is separated by different whitespace characters
    actorDict4 = {'HARAM': {'#': [('NGAREB', [])]}} #one space
    actorDict5 = {'INC': {'#': [('MNCUSA', [])]}} #two space
    actorDict6 = {'#': [('KIR', [])]} #one tab
...
def test_simple():
    ...
    dict = {'test123': {'sents': {'0': {'content': text, 'parsed': parsed}},
                'meta': {'date': '20010101'}}}
